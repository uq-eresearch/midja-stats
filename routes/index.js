...
var validate_structure = function(inp) {
  if(typeof(inp.dataset)!=='string' || typeof(inp.depVar)!=='string' || !Array.isArray(inp.indepVars) || inp.indepVars.some(function(i){return typeof(i)!=='string'})) {
...
router.post('/', function(req, res, next) {
  ...
  if(req.body.expr) {
    ...
    rio.evaluate('source("'+process.cwd()+'/regression.R"); blah <- midjaNewRegression('+rexprstr+')', {callback: function(e,r){
